...
# Install Deps
RUN dpkg --add-architecture i386 && apt-get update -y && apt-get install -y --force-yes expect git wget libc6-i386 lib32stdc++6 lib32gcc1 lib32ncurses5 lib32z1 python curl
